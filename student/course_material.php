<?php
    ...
    $getMaterial = $stu->getCourseMaterial($getStudent->level);
				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="course_material">Course Material</a>
							</li>
						</ul>
					</div>
                                ...
                                <div class="card card-with-nav">
                                    ...
                                    <div class="card-body">
                                        <form action="#" method="POST">
                                            <div class="row">
                                                <!-- I used foreach loop to interate through so as to get all the available material for this level-->
                                                <?php if(!$getMaterial) { ?>
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="text-center mt-3">
                                                                <span class="text-center fw-bold mt-5"><?php echo $materials->course_code; ?></span><br>
                                                                <span class="text-center mt-5 small"><?php echo $materials->semester; ?></span>
                                                            </div>
                                                        </div>
                                                        <div class="card-footer">
                                                            <a href="../admin/course_material/<?php echo $materials->material; ?>" download="<?php echo $materials->title; ?>" class="form-control btn btn-lg btn-success">Download</a>
                                                        </div> 
                                                    </div>  
                                                </div>
                                                <?php } ?>
