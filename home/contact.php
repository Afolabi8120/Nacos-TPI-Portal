...
<head>
  <meta charset="utf-8">
  <title>NACOS TPI | Contact Us</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-5">
        ...
        <a href="tel:+8802057843248" class="text-color h5 d-block">+2348090949669</a>
        <a href="mailto:contact@nacostpi.com" target="_blank" class="mb-5 text-color h5 d-block">contact@nacostpi.com</a>
        <p>North Campus, The Polytechnic Ibadan, Opp Biology Department<br>Ibadan, Oyo State.</p>
      </div>
    </div>
  </div>
</section>
