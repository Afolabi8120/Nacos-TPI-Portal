                                            ...
                                            <table id="basic-datatables" class="display table table-hover mb-0 data-table-export">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $fetchpayment->receipt_no; ?></td>
                                                        ...
                                                        <?php endif; ?>
                                                        <td>
                                                            <?php if($fetchpayment->picture != '') { echo '<a href="../student_img/'.$fetchpayment->picture.'" download="'.$fetchpayment->fullname.'-img'.'">Download</a>';} ?>
                                                        </td>
